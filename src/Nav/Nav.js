...
const Nav = () => {
  ...
  return (
    <div className='Nav'>
      ...
      <Link className='nav-li-right' style={{ cursor: "pointer"}} to="blog" spy={true} smooth={true}>Contact</Link>
      <Link className='nav-li-right' style={{ cursor: "pointer"}} to="contact" spy={true} smooth={true}>Blog</Link>
    </div>
  )
}
